...
class _QrReaderCodeWindowState extends ConsumerState<QrReaderCodeWindow> {
        ...
        children: [
          MobileScanner(
              ...
              onDetect: (BarcodeCapture capture) async {
                ...
                final eventToBack = ref.watch(itemSalesCurrentFilterProvider);
                isItemAlphanumeric = false;
                ...
                if (NOT_READ_QR_CODE != data && showBottomSheetForm == true) {
                  ...
                  try {
                    ...
                    validateIfAlphanumericBarCode(data, eventToBack);
                  } catch (e) {
                    validateIfAlphanumericBarCode(data, eventToBack);
                  }
                }
                ...
                if (eventToBack == FilterType.editItem && isItemAlphanumeric) {
                  ref
                  ...
                  ref
                      ...
                      .updateBarCode(data);
                } else if (findItemSomeSystemList) {
                  if (eventToBack == FilterType.updateItemList) {
                    ref
                        .read(currentIndexProvider.notifier)
  ...
  void validateIfAlphanumericBarCode(
      String data, FilterType eventToBack) async {
    if (data.isAlphanumeric) {
      ...
      if (existProduct.title.isEmpty &&
          eventToBack != FilterType.updateItemList) {
        Fluttertoast.showToast(
